...
This repo has no game-specific journal — each game-port project keeps its own (e.g.
`simant_port`'s `docs/run_status.md`); check it before building any new tooling there.
